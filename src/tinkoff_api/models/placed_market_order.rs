...
impl PlacedMarketOrder {
    pub fn new(order_id: String, operation: crate::tinkoff_api::models::OperationType, status: crate::tinkoff_api::models::OrderStatus, requested_lots: i32, executed_lots: i32) -> PlacedMarketOrder {
        PlacedMarketOrder {
            order_id,
            operation,
            status,
